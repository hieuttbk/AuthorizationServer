...
//		System.out.println("appData :"+ appData);
		...
		// cleartext.length);
		System.out.println("Random number c generated by the client111: " + (toHex(c)));
...
//		System.out.println("Qu: " + toHex(Qu));
		...
		System.out.println("c-DAStohex " + toHex(c));
		System.out.println("c-DAStohexString22 " + toHex(hexStringToByteArray(toHex(c))));
		System.out.println("Qu: " + toHex(Qu));
